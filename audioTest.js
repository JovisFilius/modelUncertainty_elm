...
{
	if (region.bb.ax === region.bo.ax)
	{
		return 'on line ' + region.bb.ax;
	}
	return 'on lines ' + region.bb.ax + ' through ' + region.bo.ax;
}
...
var $author$project$AudioTest$audioPortFromJS = _Platform_incomingPort('audioPortFromJS', $elm$json$Json$Decode$value);
var $elm$core$Basics$identity = function (x) {
	return x;
};
var $author$project$AudioTest$audioPortToJS = _Platform_outgoingPort('audioPortToJS', $elm$core$Basics$identity);
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {br: fragment, bw: host, bL: path, bN: port_, bQ: protocol, bR: query};
	});
...
var $MartinSStewart$elm_audio$Audio$audioStartTime = function (audio_) {
	return A2($ianmackenzie$elm_units$Duration$addTo, audio_.az, audio_.ak);
};
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'loopStart',
					$MartinSStewart$elm_audio$Audio$encodeDuration(loop.bC)),
					_Utils_Tuple2(
					'loopEnd',
					$MartinSStewart$elm_audio$Audio$encodeDuration(loop.bB))
				]));
	} else {
	...
	return A2(
		...
		$mgold$elm_nonempty_list$List$Nonempty$map(
			$elm$core$Tuple$mapFirst(
				function (a) {
					return A2($ianmackenzie$elm_units$Duration$addTo, a, audio_.ak);
				})),
		audio_.aF);
};
			...
			_List_fromArray(
				[
					...
					$MartinSStewart$elm_audio$Audio$encodeBufferId(
						$MartinSStewart$elm_audio$Audio$audioSourceBufferId(audio_.aa))),
					_Utils_Tuple2(
					'startTime',
					...
					_Utils_Tuple2(
					'startAt',
					$MartinSStewart$elm_audio$Audio$encodeDuration(audio_.K)),
					_Utils_Tuple2(
					'volume',
					...
					_Utils_Tuple2(
					'loop',
					$MartinSStewart$elm_audio$Audio$encodeLoopConfig(audio_.T)),
					_Utils_Tuple2(
					'playbackRate',
					$elm$json$Json$Encode$float(audio_.X))
				]));
	});
...
var $MartinSStewart$elm_audio$Audio$flattenAudio = function (audio_) {
	switch (audio_.$) {
		...
		case 1:
			var source = audio_.a.aa;
			var startTime = audio_.a.az;
			var settings = audio_.a.bX;
			return _List_fromArray(
				[
					{T: settings.T, ak: $ianmackenzie$elm_units$Quantity$zero, X: settings.X, aa: source, K: settings.K, az: startTime, ap: 1, aF: _List_Nil}
				]);
		default:
			var effect = audio_.a;
			var _v1 = effect.aN;
					...
					return A2(
						...
						function (a) {
							return _Utils_update(
								a,
								{ap: scaleVolume_.bU * a.ap});
						},
						$MartinSStewart$elm_audio$Audio$flattenAudio(effect.cp));
				case 1:
					var volumeAt = _v1.a.b5;
					return A2(
						$elm$core$List$map,
						function (a) {
							return _Utils_update(
								a,
								{
									aF: A2($elm$core$List$cons, volumeAt, a.aF)
								});
						},
						$MartinSStewart$elm_audio$Audio$flattenAudio(effect.cp));
				default:
					...
					return A2(
						...
						function (a) {
							return _Utils_update(
								a,
								{
									ak: A2($ianmackenzie$elm_units$Quantity$plus, duration, a.ak)
								});
						},
						$MartinSStewart$elm_audio$Audio$flattenAudio(effect.cp));
			}
...
var $MartinSStewart$elm_audio$Audio$updateAudioState = F2(
	function (_v0, _v1) {
		...
		var validAudio = A2(
			...
			function (_v7) {
				var a = _v7.b;
				return _Utils_eq(a.aa, audioGroup.aa) && (_Utils_eq(
					$MartinSStewart$elm_audio$Audio$audioStartTime(a),
					$MartinSStewart$elm_audio$Audio$audioStartTime(audioGroup)) && _Utils_eq(a.K, audioGroup.K));
			},
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'audioUrl',
					$elm$json$Json$Encode$string(audioLoad.as)),
					_Utils_Tuple2(
					'requestId',
		...
		var newPendingRequests = A2(
			...
			F2(
				function (index, request) {
					return _Utils_Tuple2(model.Z + index, request);
				}),
			flattenedAudioCmd);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					...
					Z: model.Z + $elm$core$List$length(flattenedAudioCmd)
				}),
			A2(
				$elm$json$Json$Encode$list,
				$elm$core$Basics$identity,
...
var $MartinSStewart$elm_audio$Audio$initHelper = F3(
	function (audioPort, audioFunc, _v0) {
		...
		var json = _v1.c;
		var initialModel = {ad: audioState, aj: newNodeGroupIdCounter, j: $elm$core$Dict$empty, Z: 0, _: $elm$core$Maybe$Nothing, s: $elm$core$Dict$empty, M: model};
					...
					F3(
						function (requestId, bufferId, duration) {
							return $MartinSStewart$elm_audio$Audio$AudioLoadSuccess(
								{
									at: bufferId,
									av: $ianmackenzie$elm_units$Duration$seconds(duration),
									aS: requestId
								});
						}),
					A2($elm$json$Json$Decode$field, 'requestId', $elm$json$Json$Decode$int),
			...
			default:
				return $elm$json$Json$Decode$succeed(
					$MartinSStewart$elm_audio$Audio$JsonParseError(
						{
							aw: 'Type ' + ($elm$core$String$fromInt(value) + ' not handled.')
						}));
		}
	},
...
var $MartinSStewart$elm_audio$Audio$fromJSPortSub = function (json) {
	...
	if (!_v0.$) {
		...
		return $MartinSStewart$elm_audio$Audio$FromJSMsg(
			$MartinSStewart$elm_audio$Audio$JsonParseError(
				{
					aw: $elm$json$Json$Decode$errorToString(error)
				}));
	}
};
			...
			_List_fromArray(
				[
					...
					A2(
						...
						model.M)),
					app.cq.cT($MartinSStewart$elm_audio$Audio$fromJSPortSub)
				]));
	});
...
var $MartinSStewart$elm_audio$Audio$updateHelper = F4(
	function (audioPort, audioFunc, userUpdate, _v0) {
		...
		var _v1 = A2(userUpdate, audioData_, model.M);
		...
		var newModel = _Utils_update(
			model,
			{ad: audioState, aj: newNodeGroupIdCounter, M: newUserModel});
	...
	function (app, msg, _v0) {
		...
		if (msg.$ === 1) {
			...
			return A4(
				...
				app.cq.dQ,
				app.cp,
				A2($MartinSStewart$elm_audio$Audio$flip, app.dV, userMsg),
				model);
		} else {
			var response = msg.a;
			switch (response.$) {
				case 0:
					var requestId = response.a.aS;
					var bufferId = response.a.at;
					var duration = response.a.av;
					var _v3 = A2($elm$core$Dict$get, requestId, model.j);
					if (!_v3.$) {
						...
						var maybeUserMsg = A2(
							...
							$mgold$elm_nonempty_list$List$Nonempty$toList(pendingRequest.N));
						if (!maybeUserMsg.$) {
							...
							return A4(
								...
								_Utils_update(
									model,
									{
										j: A2($elm$core$Dict$remove, requestId, model.j),
										s: sourceData
									}));
						} else {
							return A4(
								...
								A2(
									...
									app.dV,
									$mgold$elm_nonempty_list$List$Nonempty$head(pendingRequest.N).b),
								_Utils_update(
									model,
									{
										j: A2($elm$core$Dict$remove, requestId, model.j),
				...
				case 1:
					var requestId = response.a.aS;
					var error = response.a.aw;
					var _v6 = A2($elm$core$Dict$get, requestId, model.j);
					if (!_v6.$) {
				...
				case 2:
					var samplesPerSecond = response.a._;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								_: $elm$core$Maybe$Just(samplesPerSecond)
							}),
...
var $MartinSStewart$elm_audio$Audio$offsetBy = F2(
	function (offset_, audio_) {
		return $MartinSStewart$elm_audio$Audio$Effect(
			{
				cp: audio_,
				aN: $MartinSStewart$elm_audio$Audio$Offset(offset_)
			});
	});
		...
		return $elm$browser$Browser$element(
			{
				c0: A2(
					$elm$core$Basics$composeR,
					app.c0,
					A2($MartinSStewart$elm_audio$Audio$initHelper, app.cq.dQ, app.cp)),
				dB: $MartinSStewart$elm_audio$Audio$subscriptions(app),
				dV: $MartinSStewart$elm_audio$Audio$update(app),
				dW: function (model) {
					return A2(
						$elm$html$Html$map,
						$MartinSStewart$elm_audio$Audio$UserMsg,
...
var $author$project$AudioTest$LoadingModel = {$: 0};
var $author$project$AudioTest$SoundLoaded = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$AudioTest$init = function (_v0) {
	return _Utils_Tuple3(
		$author$project$AudioTest$LoadingModel,
		$elm$core$Platform$Cmd$none,
		A2($MartinSStewart$elm_audio$Audio$loadAudio, $author$project$AudioTest$SoundLoaded, 'beep.wav'));
};
var $MartinSStewart$elm_audio$Audio$audioDefaultConfig = {T: $elm$core$Maybe$Nothing, X: 1, K: $ianmackenzie$elm_units$Quantity$zero};
...
var $MartinSStewart$elm_audio$Audio$audioWithConfig = F3(
	function (audioSettings, source, startTime) {
		return $MartinSStewart$elm_audio$Audio$BasicAudio(
			{bX: audioSettings, aa: source, az: startTime});
	});
...
var $author$project$AudioTest$renderAudio = F2(
	function (_v0, model) {
		if (model.$ === 1) {
			var loadedModel = model.a;
			var _v2 = loadedModel.ay;
			if (!_v2.$) {
				return $MartinSStewart$elm_audio$Audio$silence;
			} else {
				var time = _v2.a;
				return A2($MartinSStewart$elm_audio$Audio$audio, loadedModel.ba, time);
			}
		} else {
			return $MartinSStewart$elm_audio$Audio$silence;
		}
...
var $author$project$AudioTest$subscriptions = F2(
	function (_v0, _v1) {
		return $elm$core$Platform$Sub$none;
	});
var $author$project$AudioTest$FailedModel = {$: 2};
var $author$project$AudioTest$LoadedModel = function (a) {
	return {$: 1, a: a};
};
var $author$project$AudioTest$Playing = function (a) {
	return {$: 1, a: a};
};
var $author$project$AudioTest$Silent = {$: 0};
var $author$project$AudioTest$ToggleTime = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$AudioTest$update = F3(
			...
			switch (_v1.a.$) {
				case 0:
					if (!_v1.b.$) {
						...
						if (!result.$) {
							var sound = result.a;
							return _Utils_Tuple3(
								$author$project$AudioTest$LoadedModel(
									{ba: sound, ay: $author$project$AudioTest$Silent}),
								$elm$core$Platform$Cmd$none,
								$MartinSStewart$elm_audio$Audio$cmdNone);
						} else {
							return _Utils_Tuple3($author$project$AudioTest$FailedModel, $elm$core$Platform$Cmd$none, $MartinSStewart$elm_audio$Audio$cmdNone);
						}
					} else {
						break _v1$3;
					}
				case 1:
					if (_v1.b.$ === 1) {
						...
						return _Utils_Tuple3(
							model,
							A2($elm$core$Task$perform, $author$project$AudioTest$ToggleTime, $elm$time$Time$now),
							$MartinSStewart$elm_audio$Audio$cmdNone);
					} else {
						break _v1$3;
					}
				default:
					if (_v1.b.$ === 1) {
						...
						var newState = function () {
							var _v5 = loadedModel.ay;
							if (!_v5.$) {
								return $author$project$AudioTest$Playing(time);
							} else {
								return $author$project$AudioTest$Silent;
							}
						}();
						return _Utils_Tuple3(
							$author$project$AudioTest$LoadedModel(
...
var $author$project$AudioTest$PlayPause = {$: 1};
...
var $mdgriffith$elm_ui$Internal$Model$asEl = 2;
var $mdgriffith$elm_ui$Internal$Style$classes = {cc: 'a', aW: 'atv', ce: 'ab', cf: 'cx', cg: 'cy', ch: 'acb', ci: 'accx', cj: 'accy', ck: 'acr', bh: 'al', bi: 'ar', cl: 'at', aX: 'ah', aY: 'av', cn: 's', ct: 'bh', cu: 'b', cv: 'w7', cx: 'bd', cy: 'bdt', aG: 'bn', cz: 'bs', aH: 'cpe', cF: 'cp', cG: 'cpx', cH: 'cpy', F: 'c', aJ: 'ctr', aK: 'cb', aL: 'ccx', G: 'ccy', au: 'cl', aM: 'cr', cJ: 'ct', cK: 'cptr', cL: 'ctxt', cS: 'fcs', bq: 'focus-within', cU: 'fs', cV: 'g', a0: 'hbh', a1: 'hc', bu: 'he', a2: 'hf', bv: 'hfp', cX: 'hv', cZ: 'ic', c$: 'fr', aP: 'lbl', c1: 'iml', c2: 'imlf', c3: 'imlp', c4: 'implw', c5: 'it', c6: 'i', bA: 'lnk', ai: 'nb', bG: 'notxt', dc: 'ol', de: 'or', V: 'oq', dg: 'oh', bJ: 'pg', bK: 'p', dh: 'ppe', dk: 'ui', w: 'r', dm: 'sb', dn: 'sbx', $7: 'sby', dp: 'sbt', dr: 'e', ds: 'cap', dt: 'sev', dz: 'sk', q: 't', dC: 'tc', dD: 'w8', dE: 'w2', dF: 'w9', dG: 'tj', aU: 'tja', dH: 'tl', dI: 'w3', dJ: 'w5', dK: 'w4', dL: 'tr', dM: 'w6', dN: 'w1', dO: 'tun', b0: 'ts', ab: 'clr', dU: 'u', bd: 'wc', b7: 'we', be: 'wf', b8: 'wfp', bf: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.cn + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cV);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.cn + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bJ);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.cn + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bK);
...
var $mdgriffith$elm_ui$Internal$Model$getStyleName = function (style) {
	switch (style.$) {
		...
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.w) + ('-' + ($elm$core$String$fromInt(pos.cI) + ('-' + ($elm$core$String$fromInt(pos.b6) + ('-' + $elm$core$String$fromInt(pos.bt)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cX, $mdgriffith$elm_ui$Internal$Style$classes.ab)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cS, $mdgriffith$elm_ui$Internal$Style$classes.ab)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aW, $mdgriffith$elm_ui$Internal$Style$classes.ab)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aW, $mdgriffith$elm_ui$Internal$Style$classes.V)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aI: closing, i: _List_Nil, J: _List_Nil, x: selector};
	});
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.x + ('{' + (renderValues(rule.J) + (rule.aI + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.w) + (' / ' + ($elm$core$String$fromInt(position.w + position.bt) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.cI) + (' / ' + ($elm$core$String$fromInt(position.cI + position.b6) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.w) + ('-' + ($elm$core$String$fromInt(position.cI) + ('-' + ($elm$core$String$fromInt(position.b6) + ('-' + $elm$core$String$fromInt(position.bt)))))));
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bt: height / size, al: size, b3: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cD, adjustment.cs, adjustment.cM, adjustment.c9]);
	var lineHeight = 1.5;
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cn, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.G, $mdgriffith$elm_ui$Internal$Style$classes.ck])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cn, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.G, $mdgriffith$elm_ui$Internal$Style$classes.ci])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cn, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.cj])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cn, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.aJ, $mdgriffith$elm_ui$Internal$Style$classes.ch])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.cn + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.q + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bd + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a1)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.cn + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.q + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.be + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a2)))));
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ai, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.cc]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ai, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.cu]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ai, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.de]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ai, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.dc]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ai, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.c$]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ai, $mdgriffith$elm_ui$Internal$Style$classes.dr, $mdgriffith$elm_ui$Internal$Style$classes.ct]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aX + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bi);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aX + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cf);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.aY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cl);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ce);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cg);
	}
};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aL + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.G + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dp + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bG)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cS: $elm$core$Maybe$Nothing, cX: $elm$core$Maybe$Nothing, da: $elm$core$Maybe$Nothing},
			options));
};
...
var $author$project$AudioTest$view = F2(
	function (_v0, model) {
		switch (model.$) {
			case 0:
				return A2(
					...
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('Loading audio ...'));
			case 1:
				var loadedModel = model.a;
				return A2(
					$mdgriffith$elm_ui$Element$layout,
					...
					A2(
						...
						_List_Nil,
						{
							c7: $mdgriffith$elm_ui$Element$text('Play/Pause'),
							dd: $elm$core$Maybe$Just($author$project$AudioTest$PlayPause)
						}));
			default:
				return A2(
					$mdgriffith$elm_ui$Element$layout,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('Failed to load audio.'));
		}
	});
var $author$project$AudioTest$main = $MartinSStewart$elm_audio$Audio$elementWithAudio(
	{
		cp: $author$project$AudioTest$renderAudio,
		cq: {cT: $author$project$AudioTest$audioPortFromJS, dQ: $author$project$AudioTest$audioPortToJS},
		c0: $author$project$AudioTest$init,
		dB: $author$project$AudioTest$subscriptions,
		dV: $author$project$AudioTest$update,
		dW: $author$project$AudioTest$view
	});
_Platform_export({'AudioTest':{'init':$author$project$AudioTest$main(
